...
namespace Ex03.GarageLogic
{
    internal class Car : Vehicle
    {
        ...
        public Car(string i_ModelName, string i_LicencePlate, Wheel[] i_Wheels,
          PowerSource i_PowerSource, eVehicleType i_VehicleType) : base(i_ModelName, i_LicencePlate, i_Wheels, i_PowerSource, i_VehicleType)
        {
        ...
        public override string ToString()
        {
            ...
            output.AppendLine(String.Format("m_NumberOfDoors : {0}", m_NumberOfDoors));
            output.AppendLine(String.Format("m_CarColor: {0}", m_CarColor));
